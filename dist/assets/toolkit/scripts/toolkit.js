...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FrontendMonster = __webpack_require__(299);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _VisualBuilder = __webpack_require__(300);
	
	var _VisualBuilder2 = _interopRequireDefault(_VisualBuilder);
	
	var _VisualFrame = __webpack_require__(308);
	
	var _VisualFrame2 = _interopRequireDefault(_VisualFrame);
	
	var _HashApi = __webpack_require__(309);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BaseEnvironment2 = __webpack_require__(302);
	    ...
	    value: function initMaterialsSelector() {
	      ...
	      for (var groupName in this.visualBuilder.settings.groups) {
	        if (this.visualBuilder.settings.groups.hasOwnProperty(groupName)) {
	          ...
	          var $list = $('<ul class="materials-list"></ul>');
	          var items = [];
...
/***/ function(module, exports) {
	...
	$(function () {
	  ...
	  var addClassesRating = function addClassesRating(element, addClasses, removeClasses) {
...
/***/ function(module, exports) {
	...
	$(function () {
		...
		$.fn.extend({
			destroyPopup: function destroyPopup($popupOpenElement) {
				var $el = $(this);
...
/***/ function(module, exports) {
	...
	$(function () {
		...
		try {
			...
			$.fn.extend({
				chosenBrowser: function chosenBrowser() {
...
/***/ function(module, exports) {
	...
	$(function () {
	  ...
	  $('.m-container > .header011').css('display', 'block');
	  ...
	  if ($('.sub-menu').hasClass('sub-menu--tabs')) {
	    $('.sub-menu--tabs .sub-item').hover(function () {
	  ...
	  $(document).on('click tap', function () {
	    if (window.innerWidth < headerMobileBreakpoint) {
	      if (menuBurgerCl && !$('.menu-mobile').hasClass('menu-mobile--show') || menuMobileCl) {
	        ...
	        $('.menu-mobile').addClass('menu-mobile--show-one').delay(100).queue(function (next) {
	  ...
	  $(document).on('click tap', function () {
	    if (window.innerWidth < leftMenuMobileBreakpoint) {
	      if (leftMenuBurgerCl && !$('.left-menu-mobile').hasClass('left-menu-mobile--show') || leftMenuMobileCl) {
	        ...
	        $('body').addClass('body--show-menu');
	        thisLeftBtn.parent().find('.left-menu-mobile').addClass('left-menu-mobile--show-one').delay(100).queue(function (next) {
...
/***/ function(module, exports) {
	...
	$(function () {
		...
		var priceHeadCalc = function priceHeadCalc() {
		...
		var priceTableDesktop = function priceTableDesktop() {
			var priceTableI = 0;
		...
		var priceTableMobile = function priceTableMobile() {
			var priceTableI = 0;
			var priceTableI1 = 1;
